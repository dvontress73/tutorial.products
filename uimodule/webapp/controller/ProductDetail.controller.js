sap.ui.define([
    ...
    return Controller.extend("tutorial.products.controller.ProductDetail", {
                ...
                events: {
                    ...
                    dataReceived: function () {
                        ...
                        this.addHistoryEntry({
                            ...
                            intent: "#display-unimodule&/Product/" + iProductId
                        })
                    }.bind(this)
                }
            });
        ...
        trimSuperfluousBytes: function (sVal) { 
            // background info https://blogs.sap.com/2017/02/08/displaying-images-in-sapui5-received-from-the-northwind-odata-service/
